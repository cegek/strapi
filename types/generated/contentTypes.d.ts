...
export interface ApiBusinessMorningBusinessMorning
  extends Schema.CollectionType {
  collectionName: 'business_mornings';
  info: {
    singularName: 'business-morning';
    pluralName: 'business-mornings';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::business-morning.business-morning',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiMemberMember extends Schema.CollectionType {
  ...
  attributes: {
    ...
    companyIcon: Attribute.Media & Attribute.Required;
    email: Attribute.Email;
...
export interface ApiRegistrationLinkRegistrationLink extends Schema.SingleType {
  collectionName: 'registration_links';
  info: {
    singularName: 'registration-link';
    pluralName: 'registration-links';
    displayName: 'registrationLink';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::registration-link.registration-link',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
